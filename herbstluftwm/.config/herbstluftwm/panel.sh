...
#selfg='#101010'
selfg='#ffffff'
#selfg=$(hc get window_border_active_color)
separatorfg=$(hc get window_border_active_color)

icons=/usr/share/icons/stlarch_icons
clock_icon=/usr/share/icons/stlarch_icons/clock1.xbm
...

{
    ...
    while true ; do
        ...
        date +$'date\t^fg(#efefef)^i(/usr/share/icons/stlarch_icons/clock1.xbm)\t%I:%M%P^fg(#909090), %Y-%m-^fg(#efefef)%d'
        sleep 1 || break
